  ...
  return (
    <section className="bg-white py-10 md:py-14">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <Reveal>
          <div className="bg-primary rounded-[32px] px-8 md:px-16 py-12 md:py-16 text-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center whitespace-nowrap h-14 px-6 sm:px-10 rounded-xl bg-white text-primary text-[15px] sm:text-lg font-semibold hover:bg-white/90 transition shadow-lg"
            >
              Hablar por WhatsApp
            </a>
